...
def compare_file(file1_name, file2_name):
    ...
    try:
        with open('result.html', 'w',encoding="utf-8") as result_file:  # 同 f = open('result.html', 'w') 打开或创建一个result.html文件
...
if __name__ == "__main__":
    compare_file(r'D:\Github\Python-little-tool\2020\微信催填报表\完整人名表单.txt',
                 r'D:\Github\Python-little-tool\2020\微信催填报表\今日已填写人名表单.txt')  # 传入两文件的路径
