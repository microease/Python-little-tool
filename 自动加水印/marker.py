...
def main():
    path = r'C:\Users\micro\Documents\GitHub\Python-little-tool\自动加水印\input'
    ...
    for i in files:
        ...
        parse.add_argument("-s", "--space", default=150, type=int, help="space between watermarks, default is 75")
        ...
        parse.add_argument("--opacity", default=0.1, type=float, help="opacity of watermarks, default is 0.15")
