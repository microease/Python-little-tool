...
def main():
    ...
    for i in files:
        ...
        parse.add_argument("-s", "--space", default=200, type=int, help="space between watermarks, default is 75")
        ...
        parse.add_argument("--opacity", default=0.08, type=float, help="opacity of watermarks, default is 0.15")
